...
def generate_launch_description():
    ...
    ld.add_action(
        Node(
            ...
            executable="static_transform_publisher",
            output="screen",
            arguments=["0.01", "0", "0.327", "-1.57079632679", "0", "-1.57079632679", "base_link", "44"]
    ...
    ld.add_action(
        Node(
            ...
            arguments=["-0.01", "0", "0.327", "1.57079632679", "0", "-1.57079632679", "base_link", "38"]
        ))
    ...
    ld.add_action(
        Node(
            ...
            output="screen",
            # X, Y, Z, Roll, Pitch, Yaw
            arguments=["0", "0.254", "0.327", "0", "0", "-1.57079632679", "base_link", "36"]
        ))
    ...
    ld.add_action(
        Node(
            ...
            output="screen",
            # X, Y, Z, Roll, Pitch, Yaw
            arguments=["0", "-0.2286", "0.327", "3.1415926535", "0", "-1.57079632679", "base_link", "41"]
        ))
    ...
    #         output="screen",
    #         # X, Y, Z, Roll, Pitch, Yaw
    #         arguments=["0.066", "0.004", "0.327", "0", "1.57079632679", "0", "front_base_link", "44"]
    #     ))
    ...
    #         output="screen",
    #         # X, Y, Z, Roll, Pitch, Yaw     green , blue, red
    #         arguments=["-0.073", "0.004", "0.324", "-1.57079632679", "1.57079632679", "1.57079632679", "front_base_link", "38"]
    #     ))
    ...
    #         output="screen",
    #         # X, Y, Z, Roll, Pitch, Yaw
    #         arguments=["-0.003", "0.065", "0.325", "0", "1.57079632679", "-1.57079632679", "front_base_link", "36"]
    #     ))
    ...
    #         output="screen",
    #         # X, Y, Z, Roll, Pitch, Yaw
    #         arguments=["-0.003", "-0.065", "0.325", "0", "1.57079632679", "1.57079632679", "front_base_link", "41"]
    #     ))
