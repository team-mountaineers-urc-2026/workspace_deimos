...
def generate_launch_description():
    ...
    # Launch Arguments
    joy_config_arg  = DeclareLaunchArgument(name = 'joy_config',        default_value = '8bit-s-arm-science',   description = 'The config file name for the controller [8bit-p-arm, 8bit-g-arm]')
    ...
    joint_control = \
        Node(
            package='controls_pkg',
            executable='science_joint_control',
            name='science_joint_control_node',
            namespace='science_manipulator',
