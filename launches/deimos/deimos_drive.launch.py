...
def generate_launch_description():
    ...
    gimbal_joy_con = \
        Node(
            ...
            executable='gimbal_joy_con',
            name='gimbal_joy_con_node'
        )
    ...
    teleop_node = \
        Node(
            ...
            # remappings={('cmd_vel', '/drivetrain/cmd_vel')} # Comment out for local driving (not through basestation)
        )
    ...
    launch_description.add_action(gimbal_joy_con)
